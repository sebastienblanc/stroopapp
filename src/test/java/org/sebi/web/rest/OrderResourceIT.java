...
import org.sebi.domain.Order;
import org.sebi.domain.enumeration.Offers;
import org.sebi.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    private static final Offers DEFAULT_OFFER = Offers.SMALL;
    private static final Offers UPDATED_OFFER = Offers.MEDIUM;
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().name(DEFAULT_NAME).offer(DEFAULT_OFFER).startDate(DEFAULT_START_DATE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().name(UPDATED_NAME).offer(UPDATED_OFFER).startDate(UPDATED_START_DATE);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getOffer()).isEqualTo(DEFAULT_OFFER);
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.name(UPDATED_NAME).offer(UPDATED_OFFER).startDate(UPDATED_START_DATE);
        ...
        assertThat(testOrder.getOffer()).isEqualTo(UPDATED_OFFER);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.name(UPDATED_NAME).startDate(UPDATED_START_DATE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.name(UPDATED_NAME).offer(UPDATED_OFFER).startDate(UPDATED_START_DATE);
